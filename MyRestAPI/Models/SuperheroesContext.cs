...
public partial class SuperheroesContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => //optionsBuilder.UseNpgsql("Server=SqlServerDb;Port=5432;User id=postgres;password=123;database=my-rest-api");
        //optionsBuilder.UseNpgsql("Host=172.19.0.2;Password=myStong_Password123#;Port=5432;Database=Superheroes;");
        optionsBuilder.UseSqlite("Data Source=Database/superheroes.db;");
        //optionsBuilder.UseNpgsql("Server=SqlServerDb; Database=Superheroes; User Id=sa; Password=myStong_Password123#; Trust Server Certificate=False;");
